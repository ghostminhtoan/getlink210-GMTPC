...
namespace get_link_manga
{
    public partial class MainWindow
    {
        private void BtnBrowseFolder_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Title = _isVietnameseUi ? "Ch?n thu m?c luu truy?n" : "Select download folder",
        ...
        private void BtnOpenFolder_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(downloadRoot))
            {
                ShowLocalizedMessageBox(
                    ...
                    "Vui lòng ch?n thu m?c luu tru?c.",
                    "Information",
                    "Thông tin",
                    MessageBoxButton.OK,
        ...
        private void BtnClearTemp_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(downloadRoot))
            {
                ShowLocalizedMessageBox(
                    "Please select a download folder first.",
                    "Vui lòng ch?n thu m?c t?i tru?c.",
                    "Information",
                    "Thông tin",
                    MessageBoxButton.OK,
                    MessageBoxImage.Warning);
            ...
            if (!Directory.Exists(tempRoot))
            {
                ...
                lblStatus.Text = _isVietnameseUi ? "Temp dã s?ch." : "Temp is already clean.";
                return;
            }

            ClearTempRootFolder(tempRoot);
            Log($"Cleared temp root: {tempRoot}");
            lblStatus.Text = _isVietnameseUi ? "Temp dã du?c xóa." : "Temp cleared.";
        }
        ...
        private void BtnOpenFolderInRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(targetFolder))
            {
                ShowLocalizedMessageBox(
                    ...
                    "Chua xác d?nh du?c thu m?c c?a truy?n này.",
                    "Warning",
                    "C?nh báo",
                    MessageBoxButton.OK,
                    MessageBoxImage.Warning);

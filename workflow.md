...
- **Tự động dò số page:** Thuật toán hoặc quy tắc Regex/HTML selector để tự động tìm kiếm và trích xuất tổng số trang/chương từ trang chi tiết (ví dụ: tìm số trang lớn nhất trong thanh phân trang pagination hoặc từ dòng chữ trạng thái `Page 1 of X`).
